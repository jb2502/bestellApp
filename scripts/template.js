...
//hinzufügen des ganzen warenkorbs im responsive
function getTemplateFullRespBasket(index) {
    return `<div id="added-dish-resp">
                        <div class="basket-under-headline">
                            <strong>${basket[index].name}</strong>
                        </div>
                        <div class="choose-basket">
                    ...
                    <div>
                        ...
                        <div class="costs">
                            <div>Zwischensumme:</div>
                            <div id="sub-total-resp">X,XX €</div>
                        </div>
                        <div class="costs">
                            <div>Lieferkosten:</div>
                            <div>${deliveryCharge.toFixed(2).replace(".", ",")} €</div>
                        ...
                        <div class="costs">
                            <div><strong>Gesamtsumme:</strong></div>
                            <div><strong id="final-total-resp">X,XX €</strong></div>
                        </div>
                        <div class="btn-container">
                            <button onclick="sendDelivery()">Bestellen <img src="./assets/icons/shopping_cart_checkout.png"
                                    alt="checkout"></button>
...
function getTemplateRespBasket(index) {
    return `<div class="basket-under-headline">
                            <strong>${basket[index].name}</strong>
                        </div>
                        <div class="choose-basket">
